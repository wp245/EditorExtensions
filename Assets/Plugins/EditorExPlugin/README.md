...
<root>
  ...
  ├── Editor
  │   ├── Punversal.Editorexplugin.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Punversal.Editorexplugin.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Punversal.Editorexplugin.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Punversal.Editorexplugin.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Punversal.Editorexplugin`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package EditorExPlugin Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Punversal.Editorexplugin.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Punversal.Editorexplugin.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Punversal.Editorexplugin.Editor.Tests.asmdef`

  `Tests/Runtime/Punversal.Editorexplugin.Tests.asmdef`
